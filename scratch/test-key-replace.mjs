...
const { client_email: clientEmail } = credentials;
let { private_key: privateKey } = credentials;

// Normalize private key carriage returns
...
async function runTests() {
  console.log('Testing with normalized private key...');
