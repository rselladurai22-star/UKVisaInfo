...
const FAQS = [
  ...
  { q: 'What house-price growth should I assume?', a: 'No one knows. UK prices have averaged roughly 3 to 4% a year long term, but with long flat or falling periods. Test a range including 0% and negative.' },
