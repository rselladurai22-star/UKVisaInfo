...
const FAQS = [
  ...
  { q: 'Does this account for stamp duty?', a: 'Yes, via the buying-costs percentage in Expert mode (a ~3% default covers SDLT plus legal and survey for a typical purchase). Use the Stamp Duty calculator for an exact figure.' },
];

export default function Page() {
  const webAppJsonLd = {
    '@context': 'https://schema.org', '@type': 'WebApplication',
    name: 'UK Buy vs Rent Calculator',
    url: 'https://ukvisainfo.co.uk/buy-vs-rent',
