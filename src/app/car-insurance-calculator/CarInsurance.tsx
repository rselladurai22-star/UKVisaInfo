...
export default function CarInsurance() {
  ...
  return (
    <CalcShell
      ...
      subtitle="Estimate your annual car insurance premium from your age, no-claims years, the car's insurance group and where you live — and learn how the 1–50 group system drives the price."
    ...
    >
      ...
      >
        <GuideSection kicker="The system" title="Insurance groups 1–50">
        ...
        <GuideSection kicker="FAQ" title="Frequently asked questions">
          <FAQ items={[
            { q: 'How do I find my car&apos;s insurance group?', a: 'It is set by the ABI/Thatcham on a 1–50 scale and listed in the car&apos;s specification or on comparison sites. Lower numbers are cheaper to insure.' },
