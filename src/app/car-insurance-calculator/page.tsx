...
export const metadata: Metadata = {
  ...
  description:
    'Free UK car insurance calculator. Estimate your annual premium from your age, no-claims years, the car’s insurance group, mileage and location, and learn how the 1–50 group system sets the price.',
