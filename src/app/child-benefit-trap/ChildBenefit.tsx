    ...
    <CalcShell
      ...
      results={
        <>
          ...
          <p className="text-[11px] text-on-surface-variant">2025/26 rates. The charge is on the higher earner&apos;s adjusted net income (£60,000–£80,000 taper). Pay it via Self Assessment, or opt out of payments to avoid it.</p>
        </>
      }
    >
      <Guide
