...
export const metadata: Metadata = {
  ...
  description:
    'Free UK High Income Child Benefit Charge calculator. See how much Child Benefit you keep when income is £60,000 to £80,000, and how a pension contribution can remove the charge. 2025/26 rates.',
