      ...
      >
        ...
        <GuideSection kicker="FAQ" title="Frequently asked questions">
          <FAQ items={[
            ...
            { q: 'What return should I assume?', a: 'Cash savings might be 3 to 5%; long-term diversified investments have historically returned around 5 to 8% before inflation, but with risk and no guarantee. Use a realistic, conservative figure.' },
