      ...
      inputs={
        <div className="space-y-4">
          ...
          <Panel title="Your Scheme">
            <div className="space-y-4">
              <Field label="Your council's maximum support (%)" hint="Working-age schemes vary; many cap at 80 to 100%">
      ...
      >
        ...
        <GuideSection kicker="Two systems" title="Pensioners vs working age">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>Working age:</strong> each council designs its own scheme. Many cap maximum support below 100% (often 80 to 90%), so even the poorest residents pay something.</li>
          </ul>
        </GuideSection>
