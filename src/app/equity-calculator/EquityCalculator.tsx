      ...
      inputs={
        <Panel title="Your property">
          <div className="space-y-4">
            ...
            <Field label={`Max LTV you could borrow to, ${maxLtv}%`} hint="Lenders typically allow up to 80 to 90% for capital raising"><Slider value={maxLtv} onChange={setMaxLtv} min={60} max={95} step={1} /></Field>
          </div>
        </Panel>
      }
      results={
    ...
    >
      ...
      >
        ...
        <GuideSection kicker="FAQ" title="Frequently asked questions">
          <FAQ items={[
            { q: 'How much equity can I release?', a: 'It depends on your property value, current mortgage and the maximum LTV the lender allows (often 80 to 90% for capital raising), plus affordability. The calculator gives a rough ceiling.' },
