        ...
        <div className="space-y-4">
          <Panel title="Your EV & Driving">
            <div className="space-y-4">
              ...
              <Field label="Efficiency (miles per kWh)" hint="Typically 3 to 4 mi/kWh"><NumberInput value={efficiency} onChange={setEfficiency} min={1} step={0.1} suffix=" mi" /></Field>
              ...
              <Field label="Public rate (p/kWh)" hint="Rapid chargers ~60 to 85p"><NumberInput value={publicRate} onChange={setPublicRate} min={0} step={5} suffix="p" /></Field>
            </div>
          </Panel>
    ...
    >
      ...
      >
        <GuideSection kicker="The basics" title="Miles per kWh and pence per kWh">
          <p>EV running cost comes down to two numbers: how far the car goes per kWh (its efficiency, typically 3 to 4 miles/kWh) and what you pay per kWh. Multiply your annual miles by the cost per mile to get the yearly bill:</p>
        ...
        <GuideSection kicker="Home vs public" title="A huge price difference">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>Public rapid:</strong> 60 to 85p/kWh, around 20p a mile, comparable to or worse than petrol.</li>
          </ul>
        </GuideSection>
        ...
        <GuideSection kicker="Avoid these" title="Common EV charging mistakes">
          <Mistakes items={[
            ...
            ['Ignoring winter efficiency', 'Cold weather and heating can cut range by 20 to 30%, raising cost per mile.'],
        ...
        <GuideSection kicker="FAQ" title="Frequently asked questions">
          <FAQ items={[
            ...
            { q: 'Is public charging expensive?', a: 'Rapid public chargers often cost 60 to 85p/kWh, which can work out around 20p a mile, similar to or more than petrol.' },
