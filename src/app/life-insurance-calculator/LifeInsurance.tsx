      ...
      >
        ...
        <GuideSection kicker="FAQ" title="Frequently asked questions">
          <FAQ items={[
            ...
            { q: 'Do I need cover if I have it through work?', a: "Death-in-service cover is valuable but usually only 2 to 4× salary and ends if you leave the job. It rarely replaces a full personal policy." },
          ]} />
        </GuideSection>
