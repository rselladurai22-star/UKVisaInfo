...
export default async function NewsItemPage({ params }: RouteParams) {
  ...
  return (
    <>
      <header className="relative isolate overflow-hidden bg-gradient-to-br from-[#0a1530] via-[#0e1b3f] to-[#13204a] pt-[100px] md:pt-[120px] pb-10 md:pb-14">
        ...
        <article className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 py-10 md:py-14">
          <div className="prose-content">
            <ReactMarkdown
              ...
              components={{
                ...
                strong: ({ children }) => <strong className="font-bold text-[#0a1530]">{children}</strong>,
          ...
          {n.source && (
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#fafbfd] border border-[rgba(14,20,36,0.07)] text-[#0a1530] text-[13px] font-semibold hover:border-[#0a1530] transition-colors duration-100"
            >
          ...
          {others.length > 0 && (
            <section className="mt-12 pt-8 border-t border-[rgba(14,20,36,0.08)]">
              ...
              <ul className="space-y-2">
                {others.map((o) => (
                  <li key={o.slug}>
                    <Link href={`/news/${o.slug}`} className="group flex items-center gap-3 p-3 rounded-xl border border-[rgba(14,20,36,0.06)] bg-white hover:border-[#0a1530] transition-colors duration-100">
                      ...
                      <span className="text-[13.5px] font-semibold text-[#0a1530] truncate flex-1 group-hover:text-[#d9152b] transition-colors duration-100">{o.title}</span>
