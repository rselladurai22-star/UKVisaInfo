    ...
    >
      ...
      >
        ...
        <GuideSection kicker="The catch" title="The 10% rule and early repayment charges">
          <p>Most fixed and discounted deals let you overpay up to <strong>10% of the outstanding balance each year</strong> without penalty. Go beyond that during the fixed period and you may face an <strong>early repayment charge (ERC)</strong>, often 1 to 5% of the excess. Always check your annual allowance before making a large overpayment. Once you&apos;re on the standard variable rate, there&apos;s usually no ERC and you can overpay freely.</p>
