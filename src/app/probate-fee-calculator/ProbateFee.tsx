        ...
        <>
          ...
          {route === 'full' && (
            <Callout tone="warn" title="Percentage fees add up fast">
              Some solicitors and banks charge 1%–5% of the estate <em>plus</em> an hourly rate. On a £350,000 estate that can mean £3,500–£17,500. Always get a fixed-fee quote and compare.
            </Callout>
          )}
      ...
      >
        ...
        <GuideSection kicker="Using a professional" title="Solicitor and bank fees">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Grant-only ("grant of probate") service:</strong> a fixed fee, typically £900–£2,000, where the solicitor obtains the grant and you do the rest.</li>
        ...
        <GuideSection kicker="Worked example" title="A £350,000 estate, DIY vs solicitor">
          <p>On a £350,000 estate with no IHT, the DIY route costs £300 plus, say, three copies (£4.50) — about £304.50. A grant-only solicitor might add £900–£2,000. A full-administration solicitor charging 2% could cost around £7,000 plus the court fee. The work involved — not the estate size — should drive which route you choose.</p>
        </GuideSection>
        ...
        <GuideSection kicker="FAQ" title="Frequently asked questions">
          <FAQ items={[
            { q: 'Is probate always required?', a: 'Not always. Jointly-owned assets usually pass to the survivor automatically, and many banks release small balances (often up to £20,000–£50,000) without a grant.' },
            { q: 'How long does probate take?', a: 'Once submitted, the grant typically takes 8–16 weeks. Administering the whole estate can take 6–12 months or longer.' },
