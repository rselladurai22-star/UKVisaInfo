    ...
    >
      ...
      >
        <GuideSection kicker="History" title="What UK house prices have actually done">
          <p>Over the long run, UK house prices have grown roughly in line with — or a little above — incomes, averaging somewhere around 3–4% a year in nominal terms across recent decades. But that average hides long flat spells and real falls, such as the early-1990s slump and the 2008 financial crisis. Growth is also wildly uneven by region: London and the South East surged for years before slowing, while parts of the North have only recently recovered earlier peaks.</p>
        </GuideSection>
        ...
        <GuideSection kicker="FAQ" title="Frequently asked questions">
          <FAQ items={[
            { q: 'How much do UK house prices grow each year?', a: 'Historically around 3–4% a year on average in nominal terms, but with long flat periods and occasional falls, and big regional differences. No average guarantees any individual property&apos;s outcome.' },
            { q: 'What growth rate should I assume?', a: 'A central case of 2–4% is common, but test a range. The low-to-high band in the calculator shows how much the assumption changes the result.' },
