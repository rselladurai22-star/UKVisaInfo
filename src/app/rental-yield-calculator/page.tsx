...
const FAQS = [
  { q: 'What is a good rental yield in the UK?', a: 'A net yield of 5% or more is generally considered healthy. Gross yields of 6 to 8% are common in higher-yield northern cities, while London often sits below 4% gross.' },
