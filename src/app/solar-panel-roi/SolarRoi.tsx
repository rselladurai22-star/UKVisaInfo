      ...
      inputs={
        <Panel title="Your System">
          <div className="space-y-4">
            <Field label="System size (kWp)" hint="A typical home system is 3.5 to 5 kWp"><NumberInput value={systemKw} onChange={setSystemKw} min={1} step={0.5} suffix=" kWp" /></Field>
      ...
      >
        <GuideSection kicker="How it pays" title="Two sources of value">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>Export income:</strong> surplus power sent back to the grid earns money under the Smart Export Guarantee (SEG), typically 5 to 15p/kWh depending on supplier.</li>
          </ul>
        </GuideSection>
        ...
        <GuideSection kicker="Self-use" title="Why timing matters so much">
          ...
          <Callout tone="warn" title="Batteries add cost and payback">
            A home battery boosts self-use but can add £3,000 to £5,000. It improves savings but usually lengthens the overall payback, so model it carefully.
          </Callout>
        </GuideSection>

        <GuideSection kicker="Worked example" title="A 4 kWp system at £6,500">
          <p>A 4 kWp system generates about 3,600 kWh a year. With 50% self-use at 27p, that's about £486 in bill savings, plus 1,800 kWh exported at 15p for £270, roughly £756 a year. Against a £6,500 install, payback is around 8 to 9 years, after which it's largely profit across the panels' 25-year-plus life.</p>
        </GuideSection>
        ...
        <GuideSection kicker="Avoid these" title="Common solar mistakes">
          <Mistakes items={[
            ...
            ['Forgetting inverter replacement', 'Inverters often need replacing once in the system life, an extra £800 to £1,500.'],
        ...
        <GuideSection kicker="FAQ" title="Frequently asked questions">
          <FAQ items={[
            { q: 'How long do solar panels take to pay back?', a: 'Typically 8 to 12 years in the UK, depending on system cost, self-use and export rates. Panels usually last 25 years or more.' },
