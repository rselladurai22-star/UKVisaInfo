  ...
  return (
    <>
      <header className="relative isolate overflow-hidden bg-gradient-to-br from-[#0a1530] via-[#0e1b3f] to-[#13204a] pt-[100px] md:pt-[120px] pb-12 md:pb-14">
        ...
        <div className="absolute -top-32 -right-24 w-[480px] h-[480px] rounded-full bg-[#2563eb]/15 blur-[120px] pointer-events-none" />
          ...
          <div className="grid grid-cols-12 gap-8 lg:gap-10">
            <main className="col-span-12 lg:col-span-8 space-y-5">
              {cities.map(([city, items]) => (
                <section key={city} className="rounded-3xl bg-white border border-[rgba(14,20,36,0.07)] p-6 md:p-7 shadow-[0_2px_12px_rgba(10,21,48,0.04)]">
                  <div className="mb-5 pb-4 border-b border-[rgba(14,20,36,0.06)] flex items-baseline justify-between gap-3">
                    <h2 className="font-display text-[1.25rem] font-bold text-[#0a1530] tracking-[-0.015em] flex items-center gap-2">
                      <MapPin className="w-4 h-4 text-[#d9152b]" />
                      {city}
                    </h2>
                    <Link href={`/sponsors/city/${slugify(city)}`} className="text-[12px] font-semibold text-[#d9152b] hover:underline">
                      All in {city} →
                    </Link>
                  </div>
            ...
            <aside className="col-span-12 lg:col-span-4">
              <div className="lg:sticky lg:top-[100px] space-y-4">
                        ...
                        <li key={s}>
                          <Link
                            ...
                            className={`flex items-center justify-between gap-2 px-3 py-2 rounded-lg text-[13px] transition-colors duration-100 ${
                              active ? 'bg-[#0a1530] text-white' : 'text-[#52596e] hover:bg-[#f3f5fb]'
                            }`}
                          >
                ...
                <Link
                  ...
                  className="group block rounded-2xl bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] p-5 text-white relative overflow-hidden"
                >
