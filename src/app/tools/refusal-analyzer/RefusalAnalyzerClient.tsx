    ...
    <>
      ...
      <header className="relative isolate overflow-hidden bg-gradient-to-br from-[#0a1530] via-[#0e1b3f] to-[#13204a] pt-[100px] md:pt-[120px] pb-12 md:pb-16">
        ...
        <div className="relative max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 text-center">
          <span className="inline-flex items-center gap-1.5 text-[10.5px] font-bold uppercase tracking-[0.12em] text-[#ffbf47] mb-4">
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-white/45 text-[12px]">
            ...
            <span className="flex items-center gap-1.5"><ShieldCheck className="w-3.5 h-3.5 text-[#ffbf47]" /> Based on Home Office decision-letter rules</span>
          </div>
        </div>
      </header>
            ...
            <main className="col-span-12 lg:col-span-8 space-y-5">
              ...
              <section className="rounded-3xl bg-white border border-[rgba(14,20,36,0.07)] p-6 md:p-7 shadow-[0_2px_12px_rgba(10,21,48,0.04)]">
                ...
                <textarea
                  ...
                  className="w-full min-h-[260px] md:min-h-[320px] p-4 rounded-2xl border border-[rgba(14,20,36,0.1)] bg-[#fafbfd] focus:bg-white focus:border-[#0a1530] outline-none transition-colors duration-100 text-[14px] leading-relaxed text-[#0a1530] placeholder:text-[#9aa3b8] font-mono resize-y"
                  spellCheck={false}
                />
                <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
                  <div className="text-[11.5px] text-[#7a8195] tabular-nums">
                    {wordCount} words · {charCount} chars
                    {charCount > 0 && charCount < 50 && <span className="text-[#d97706] ml-2">(too short to analyze)</span>}
                  </div>
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 bg-[#d9152b] text-white font-bold px-5 py-2.5 rounded-xl text-[13px] hover:bg-[#b8101f] active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed transition-[background,transform] duration-100 shadow-[0_4px_14px_rgba(217,21,43,0.32)]"
                    >
              ...
              {/* Results */}
              {submitted && (
                <section id="analysis-results" className="rounded-3xl bg-white border border-[rgba(14,20,36,0.07)] p-6 md:p-7 shadow-[0_2px_12px_rgba(10,21,48,0.04)] scroll-mt-24">
                  ...
                  {/* Always-on advice */}
                  <div className="mt-6 p-5 rounded-2xl bg-gradient-to-br from-[#0a1530] to-[#13204a] text-white relative overflow-hidden">
                    <div className="absolute -right-12 -bottom-12 w-40 h-40 rounded-full bg-[#d9152b]/25 blur-3xl pointer-events-none" />
                    <div className="relative z-10">
                      <div className="text-[10.5px] font-bold uppercase tracking-[0.12em] text-[#ffbf47] mb-2">
                        Important
                      </div>
              ...
              {!submitted && (
                <section className="rounded-3xl bg-white border border-[rgba(14,20,36,0.07)] p-6 md:p-7 shadow-[0_2px_12px_rgba(10,21,48,0.04)]">
                  <div className="text-[10.5px] font-bold uppercase tracking-[0.14em] text-[#d9152b] mb-2">How it works</div>
                  <h3 className="font-display text-[1.125rem] font-bold text-[#0a1530] mb-4">
                    Three quick steps
                  </h3>
                  <ol className="space-y-3">
                    {[
                      ...
                      <li key={i} className="flex gap-3 items-start p-3.5 rounded-xl bg-[#fafbfd] border border-[rgba(14,20,36,0.05)]">
                        <span className="w-7 h-7 rounded-full bg-[#0a1530] text-white font-display font-bold text-[12px] flex items-center justify-center flex-shrink-0">{i + 1}</span>
                        <div>
                          <div className="text-[14.5px] font-bold text-[#0a1530]">{s.t}</div>
                          <div className="text-[13px] text-[#52596e] mt-0.5">{s.d}</div>
                        </div>
                      </li>
                    ))}
                  </ol>
              ...
              <div className="lg:sticky lg:top-[100px] space-y-4">
                ...
                <div className="rounded-2xl bg-white border border-[rgba(14,20,36,0.07)] p-5">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <div>
                      <div className="text-[13.5px] font-bold text-[#0a1530] leading-tight">Need expert help?</div>
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      <li key={l.href}>
                        <Link
                          href={l.href}
                          className="group flex items-start gap-2 text-[13px] text-[#52596e] hover:text-[#0a1530] transition-colors duration-100"
                        >
                          <BookOpen className="w-3.5 h-3.5 text-[#d9152b] flex-shrink-0 mt-0.5" />
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-3">
        <span className="w-7 h-7 rounded-full bg-white text-[#0a1530] font-display font-bold text-[12px] flex items-center justify-center flex-shrink-0 border border-[rgba(14,20,36,0.08)]">
          {index}
        </span>
        <span
      ...
      <h3 className="font-display font-bold text-[1.0625rem] md:text-[1.125rem] text-[#0a1530] leading-tight tracking-[-0.01em] mb-3">
        {f.title}
      </h3>
      ...
      <div className="mt-3 pt-3 border-t border-[rgba(14,20,36,0.08)] text-[11.5px] text-[#7a8195]">
        Matched on: <code className="bg-white/60 px-1.5 py-0.5 rounded font-mono text-[#0a1530]">&ldquo;{f.matchedText}&rdquo;</code>
      </div>
    </li>
  );
}
...
function Row({ label, children, highlight }: { label: string; children: React.ReactNode; highlight?: boolean }) {
  return (
    <div className={`flex flex-col sm:flex-row gap-1.5 sm:gap-3 ${highlight ? 'pt-2.5 mt-2 border-t border-[rgba(14,20,36,0.08)]' : ''}`}>
      ...
      <dd className={`flex-1 leading-[1.65] ${highlight ? 'font-semibold text-[#0a1530]' : 'text-[#1a2240]'}`}>
        {children}
      </dd>
    </div>
  );
