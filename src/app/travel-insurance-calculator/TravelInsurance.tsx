        ...
        <>
          ...
          <Panel title="Cover limits to look for">
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex justify-between"><span className="text-on-surface-variant">Baggage</span><span className="font-semibold">£1,500–£2,500</span></li>
    ...
    >
      ...
      >
        ...
        <GuideSection kicker="FAQ" title="Frequently asked questions">
          <FAQ items={[
            { q: 'How much medical cover do I need?', a: 'At least £2 million for Europe and £5–£10 million worldwide. Higher is sensible for the USA, where treatment and repatriation are very costly.' },
