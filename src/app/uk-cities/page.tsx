            ...
            {cities.map((c) => (
              ...
              >
                <div className="flex items-start justify-between gap-3 mb-2">
                  <div className="font-display font-bold text-[18px] text-[#0a1530] leading-tight">{c.name}</div>
                  {c.status === 'stub' && (
                ...
                <div className="flex items-center justify-between pt-3 border-t border-[rgba(14,20,36,0.06)]">
                  <span className="inline-flex items-center gap-1.5 text-[12px] text-[#52596e]">
                    ...
                    <strong className="text-[#0a1530] tabular-nums">£{c.monthlyCost.total}</strong>/mo
                  </span>
                  <span className="inline-flex items-center gap-1 text-[12px] font-bold text-[#d9152b] group-hover:gap-2 transition-[gap] duration-100">
