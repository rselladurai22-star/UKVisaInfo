    ...
    return (
      <div className="flex items-center gap-2.5 text-[12px]" style={{ color: SLATE }}>
        <span aria-hidden
              ...
              style={{ background: INK, color: CREAM, fontFamily: '"Inter", -apple-system, system-ui, sans-serif', letterSpacing: '-0.01em' }}>
          {e.initials}
        </span>
        <span>
    ...
    <div className="rounded-2xl overflow-hidden"
      ...
      <div className="px-5 py-4 flex items-start gap-4">
        <span aria-hidden
              ...
              style={{ background: INK, color: CREAM, fontFamily: '"Inter", -apple-system, system-ui, sans-serif', letterSpacing: '-0.012em' }}>
          {e.initials}
        </span>
