...
const GOLD    = '#B8860B';   // warm complement (unchanged)
const SLATE   = '#516F90';   // HubSpot slate body
    ...
    <>
      <header
        ...
        style={{
          ...
          boxShadow: scrolled ? '0 1px 24px -8px rgba(33,51,67,0.10)' : 'none',
        }}
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 h-[68px] md:h-[72px] flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 ml-auto">
            <Link
              ...
              style={{ color: SLATE }}
              onMouseOver={(e) => { e.currentTarget.style.color = INK; e.currentTarget.style.background = 'rgba(33,51,67,0.04)'; }}
            ...
            <Link
              ...
              style={{
                background: EMERALD,
                color: '#FFFFFF',
                boxShadow: '0 2px 14px -4px rgba(255,122,89,0.40)',
              }}
              onMouseOver={(e) => { e.currentTarget.style.background = '#FF5C35'; }}
              onMouseOut={(e)  => { e.currentTarget.style.background = EMERALD; }}
            >
          ...
          return (
            <li key={t.href}>
              <Link
                ...
                style={{ background: isActive ? 'rgba(255,122,89,0.07)' : 'transparent' }}
        ...
        <aside className="col-span-3 flex flex-col">
          ...
          <div
            ...
            style={{
              ...
              color: INK, minHeight: 280, padding: 28,
            }}
          >
            <div style={{
              fontFamily: FONT_DISPLAY,
      ...
      <div className="p-4 flex-shrink-0" style={{ borderTop: `1px solid ${HAIR}` }}>
        <Link
          ...
          style={{
            background: EMERALD,
            color: '#FFFFFF',
            boxShadow: '0 4px 18px rgba(255,122,89,0.32)',
          }}
        >
  ...
  return (
    <div className="p-4">
      ...
      <Link href="/visa-types" onClick={onClose}
            ...
            style={{ background: 'rgba(33,51,67,0.04)', color: INK }}>
