...
const APP_TILES: AppTile[] = [
  ...
  { href: '/child-benefit-calculator',    label: 'Child Benefit',       hint: '£25.60/wk · HICBC taper',            icon: Baby,           accent: '#EC4899', live: true },
  { href: '/marriage-allowance-calculator', label: 'Marriage Allowance', hint: '£1,260 PA transfer · £252 saving',   icon: Heart,          accent: ROSE,      live: true },
  { href: '/company-car-tax',             label: 'Company Car Tax',     hint: 'BiK · CO₂% · EV / PHEV / diesel',     icon: Car,            accent: NAVY,      live: true },
  { href: '/ir35-calculator',             label: 'IR35 Calculator',     hint: 'Inside vs outside — take-home diff',  icon: Shield,         accent: VIOLET,    live: true },
  { href: '/contractor-day-rate',         label: 'Contractor Day Rate', hint: 'Day rate → Ltd vs PAYE comparison',   icon: Briefcase,      accent: BLUE,      live: true },
  { href: '/mileage-expense-calculator',  label: 'Mileage Expenses',    hint: 'AMAP 45p/25p car · 24p motorcycle',   icon: MapPin,         accent: EMERALD,   live: true },
  { href: '/salary-sacrifice-calculator', label: 'Salary Sacrifice',    hint: 'IT + NI saving vs relief at source',  icon: PiggyBank,      accent: TEAL,      live: true },
  { href: '/self-assessment-calculator',  label: 'Self Assessment',     hint: 'Multi-income SA estimate + POAC',     icon: FileText,       accent: AMBER,     live: true },
  { href: '/rental-income-tax',           label: 'Rental Income Tax',   hint: 'Section 24 · mortgage interest credit', icon: HomeIcon,     accent: GOLD,      live: true },
  { href: '/rental-yield-calculator',     label: 'Rental Yield',        hint: 'Gross/net yield · BTL ICR check',     icon: TrendingUp,     accent: EMERALD,   live: true },
  { href: '/overpayment-mortgage',        label: 'Mortgage Overpayment', hint: 'Interest saved · months off term',   icon: LandmarkIcon,   accent: BLUE,      live: true },
  { href: '/property-cgt-calculator',     label: 'Property CGT',        hint: 'PPR relief · 18%/24% Oct 2024',       icon: Building2,      accent: NAVY,      live: true },
  { href: '/childcare-calculator',        label: 'Childcare Costs',     hint: '15/30 free hrs · TFC · UC 85%',        icon: Baby,           accent: '#7C3AED', live: true },
  { href: '/isa-calculator',              label: 'ISA Growth',          hint: '£20k ISA · LISA bonus · projection',  icon: Wallet,         accent: TEAL,      live: true },
  { href: '/ihs-calculator',              label: 'IHS Surcharge',       hint: '£1,035/yr · students £776/yr',         icon: HeartPulse,     accent: '#0EA5E9', live: true },
  { href: '/skilled-worker-points-check', label: 'Skilled Worker Points', hint: '70-point check · shortage/new entrant', icon: GraduationCap, accent: GOLD,  live: true },
  { href: '/notice-period-calculator',    label: 'Notice Period',       hint: 'Statutory 1wk/yr · PILON taxable',    icon: Clock,          accent: ROSE,      live: true },
  { href: '/minimum-wage-checker',        label: 'Minimum Wage',        hint: 'NLW £12.21 · Apr 2025 rates',          icon: Scale,          accent: EMERALD,   live: true },
  { href: '/pension-drawdown-calculator', label: 'Pension Drawdown',    hint: 'PCLS 25% · year-by-year projection',  icon: Coins,          accent: GOLD,      live: true },
  { href: '/lifetime-isa-calculator',     label: 'Lifetime ISA',        hint: '25% bonus · first home · retirement', icon: Star,           accent: AMBER,     live: true },
];
