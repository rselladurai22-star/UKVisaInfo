...
const ROUTES: VisaRoute[] = [
  /* WORK */
  { id:'skilled-worker',   title:'Skilled Worker',             blurb:'Employer-sponsored at any eligible SOC occupation. Most common route to ILR.',          fee:'from £610',              baseFee:610,   ihsPerYear:1035, duration:'3–5 yr',    toILR:'5 years',                      accent:'#6366F1', icon:Briefcase,    tab:'work',        badge:'Most popular', href:'/visa-types/skilled-worker'    },
  { id:'health-care',      title:'Health & Care Worker',       blurb:'NHS and eligible social care roles. IHS fully waived for all applicants.',               fee:'from £247',              baseFee:247,   ihsPerYear:0,    duration:'3 yr',      toILR:'5 years',                      accent:'#10B981', icon:Building2,    tab:'work',        badge:'IHS waived',  href:'/visa-types/health-and-care'   },
  { id:'global-talent',    title:'Global Talent',              blurb:'Endorsed leaders in digital tech, arts, science or academia. No sponsor needed.',        fee:'£167 + endorsement',     baseFee:167,   ihsPerYear:1035, duration:'Flexible',  toILR:'3–5 years',                    accent:'#7C3AED', icon:Star,         tab:'work',        href:'/visa-types/global-talent'     },
  { id:'innovator-founder',title:'Innovator Founder',          blurb:'Endorsed founders with innovative, viable and scalable business plan.',                  fee:'£1,357',                 baseFee:1357,  ihsPerYear:1035, duration:'3 yr',      toILR:'3 years',                      accent:'#F59E0B', icon:Zap,          tab:'work',        href:'/visa-types/innovator-founder' },
  { id:'scale-up',         title:'Scale-up Worker',            blurb:'Fast-growing companies. Unsponsored after 6 months of initial approval.',                fee:'from £610',              baseFee:610,   ihsPerYear:1035, duration:'2 yr',      toILR:'5 years',                      accent:'#1E3A8A', icon:Target,       tab:'work',        href:'/visa-types/scale-up'          },
  { id:'ict-senior',       title:'Senior / Specialist (ICT)',  blurb:'Intra-company transfers for established employees in specialist or senior roles.',        fee:'from £610',              baseFee:610,   ihsPerYear:1035, duration:'Up to 9 yr',toILR:'5 yr (switch to SW)',           accent:'#0EA5E9', icon:Building2,    tab:'work',        href:'/visa-types/ict'               },
  { id:'grad-trainee',     title:'Graduate Trainee (ICT)',     blurb:'Intra-company transfer for graduate trainees on a structured programme.',                 fee:'from £247',              baseFee:247,   ihsPerYear:1035, duration:'1 yr',      toILR:null,                           accent:'#0EA5E9', icon:GraduationCap,tab:'work',        href:'/visa-types/ict'               },
  { id:'seasonal',         title:'Seasonal Worker',            blurb:'Horticulture, food processing and poultry via licensed scheme operators. No IHS.',        fee:'£298',                   baseFee:298,   ihsPerYear:0,    duration:'Up to 6 m', toILR:null,                           accent:'#84CC16', icon:Leaf,         tab:'work',        href:'/visa-types/seasonal'          },
  { id:'sportsperson',     title:'Sportsperson',               blurb:'Elite athletes and coaches endorsed by a UK governing body.',                             fee:'£298',                   baseFee:298,   ihsPerYear:1035, duration:'3 yr',      toILR:null,                           accent:'#F59E0B', icon:Target,       tab:'work',        href:'/visa-types/sportsperson'      },
  { id:'minister-rel',     title:'Minister of Religion',       blurb:'Religious workers sponsored by a UK religious organisation.',                             fee:'£298',                   baseFee:298,   ihsPerYear:1035, duration:'3 yr',      toILR:'5 years',                      accent:'#A78BFA', icon:Star,         tab:'work',        href:'/visa-types/minister-of-religion'},
  { id:'intl-agreement',   title:'International Agreement',    blurb:'Workers under GATS/CETA treaties or private servants of diplomats.',                     fee:'£298',                   baseFee:298,   ihsPerYear:0,    duration:'Varies',    toILR:null,                           accent:'#3F3F46', icon:Globe,        tab:'work',        href:'/visa-types/international-agreement'},
  /* STUDY */
  { id:'student',          title:'Student Visa',               blurb:'Degree-level+ at UKVI-licensed sponsor. Up to 20 hrs/wk work in term time.',            fee:'£363 outside / £490 in-UK',baseFee:363,  ihsPerYear:776,  duration:'1–5 yr',    toILR:null,                           accent:'#1E3A8A', icon:GraduationCap,tab:'study',       badge:'Popular',     href:'/visa-types/student'           },
  { id:'child-student',    title:'Child Student',              blurb:'Independent school study for children aged 4–17 at a licensed school.',                  fee:'£363',                   baseFee:363,   ihsPerYear:776,  duration:'Up to 6 yr',toILR:null,                           accent:'#0EA5E9', icon:Baby,         tab:'study',       href:'/visa-types/child-student'     },
  { id:'short-study',      title:'Short-term Study',           blurb:'English language study up to 6 months (11 months with academic qualification).',         fee:'£200',                   baseFee:200,   ihsPerYear:0,    duration:'Up to 11 m',toILR:null,                           accent:'#60A5FA', icon:BookOpen,     tab:'study',       href:'/visa-types/short-term-study'  },
  { id:'graduate',         title:'Graduate Visa',              blurb:'Stay and work 2 years (3 for PhD) after graduating. No sponsor needed.',                 fee:'£822',                   baseFee:822,   ihsPerYear:1035, duration:'2–3 yr',    toILR:null,                           accent:'#6366F1', icon:GraduationCap,tab:'study',       href:'/visa-types/graduate'          },
  /* FAMILY */
  { id:'spouse-partner',   title:'Spouse / Partner',           blurb:'Join a British citizen or settled person. Min income £29,000. 5 yrs to ILR.',           fee:'£1,846 outside',         baseFee:1846,  ihsPerYear:1035, duration:'2.5 yr',    toILR:'5 years',                      accent:'#E11D48', icon:Heart,        tab:'family',      badge:'Popular',     href:'/visa-types/family'            },
  { id:'fiancee',          title:'Fiancé(e)',                  blurb:'Marry or register civil partnership within 6 months, then switch to Spouse visa.',       fee:'£1,846',                 baseFee:1846,  ihsPerYear:0,    duration:'6 months',  toILR:'5 yr (after switch)',           accent:'#F43F5E', icon:Heart,        tab:'family',      href:'/visa-types/family'            },
  { id:'child-dep',        title:'Child Joining Parents',      blurb:'Children under 18 joining both parents or a lone parent who are settled.',               fee:'£1,846',                 baseFee:1846,  ihsPerYear:1035, duration:'2.5 yr',    toILR:'5 years',                      accent:'#FB923C', icon:Baby,         tab:'family',      href:'/visa-types/family'            },
  { id:'parent-brit',      title:'Parent of British Child',    blurb:'Parent of a British or settled child under 18, with sole responsibility.',               fee:'£1,846',                 baseFee:1846,  ihsPerYear:1035, duration:'2.5 yr',    toILR:'5 years',                      accent:'#FBBF24', icon:Users,        tab:'family',      href:'/visa-types/family'            },
  { id:'adult-dep',        title:'Adult Dependent Relative',   blurb:'Elderly or incapacitated relatives needing personal care from a settled person.',        fee:'£3,250',                 baseFee:3250,  ihsPerYear:1035, duration:'2.5 yr',    toILR:'5 years',                      accent:'#4F46E5', icon:Users,        tab:'family',      href:'/visa-types/family'            },
  /* VISIT */
  { id:'visitor-std',      title:'Standard Visitor',           blurb:'Tourism, family visit, medical treatment or business meetings. Up to 6 months.',         fee:'from £115 (6m) to £963 (10yr)',baseFee:115,ihsPerYear:0, duration:'6m – 10yr', toILR:null,                           accent:'#4F46E5', icon:Plane,        tab:'visit',       badge:'Popular',     href:'/visa-types/visitor'           },
  { id:'marriage-visitor', title:'Marriage Visitor',           blurb:'Visit to marry or register a civil partnership. Cannot switch in-UK.',                   fee:'£115',                   baseFee:115,   ihsPerYear:0,    duration:'6 months',  toILR:null,                           accent:'#F97316', icon:Heart,        tab:'visit',       href:'/visa-types/visitor'           },
  { id:'ppe-visitor',      title:'Permitted Paid Engagement',  blurb:'Up to 1 month for specific paid work (academic, creative, sport).',                      fee:'£115',                   baseFee:115,   ihsPerYear:0,    duration:'1 month',   toILR:null,                           accent:'#EAB308', icon:Briefcase,    tab:'visit',       href:'/visa-types/visitor'           },
  { id:'transit',          title:'Direct Airside Transit',     blurb:'Pass through a UK airport without going through UK border control.',                     fee:'£64',                    baseFee:64,    ihsPerYear:0,    duration:'Transit',   toILR:null,                           accent:'#3F3F46', icon:Plane,        tab:'visit',       href:'/visa-types/visitor'           },
  /* SETTLEMENT */
  ...
  /* SPECIAL */
  { id:'uk-ancestry',      title:'UK Ancestry',                blurb:'Commonwealth citizens with a UK-born grandparent. 5 yr unrestricted work → ILR.',        fee:'£632',                   baseFee:632,   ihsPerYear:1035, duration:'5 yr',      toILR:'5 years',                      accent:'#F59E0B', icon:Star,         tab:'special',     href:'/visa-types/ancestry'          },
  { id:'bno-visa',         title:'Hong Kong BN(O)',             blurb:'BN(O) status holders and close family. Work and live freely for 5yr then ILR + citizenship.',fee:'£180 (2yr) / £250 (5yr)',baseFee:180,   ihsPerYear:1035, duration:'5 yr',      toILR:'5 years',                      accent:'#EC4899', icon:Flag,         tab:'special',     badge:'New route',   href:'/visa-types/bno'               },
  { id:'youth-mobility',   title:'Youth Mobility Scheme',      blurb:'18–30 from eligible countries (AU, NZ, CA, JP etc.). 2yr open work, no sponsor.',        fee:'£298',                   baseFee:298,   ihsPerYear:1035, duration:'2 yr',      toILR:null,                           accent:'#06B6D4', icon:Plane,        tab:'special',     href:'/visa-types/youth-mobility'    },
  { id:'hpi',              title:'High Potential Individual',  blurb:'Graduates of top 50 global universities within 5 years. 2yr open work, no sponsor.',     fee:'£822',                   baseFee:822,   ihsPerYear:1035, duration:'2 yr',      toILR:null,                           accent:'#8B5CF6', icon:Zap,          tab:'special',     href:'/visa-types/hpi'               },
  { id:'ukraine-family',   title:'Ukraine Family Scheme',      blurb:'Immediate or extended family of British nationals in Ukraine. Indefinite permission.',   fee:'Free',                   baseFee:0,     ihsPerYear:0,    duration:'3 yr',      toILR:null,                           accent:'#F59E0B', icon:Heart,        tab:'special',     badge:'Free',        href:'/visa-types/ukraine'           },
  { id:'homes-ukraine',    title:'Homes for Ukraine',          blurb:'Ukrainian individuals with a named sponsor host in the UK.',                              fee:'Free',                   baseFee:0,     ihsPerYear:0,    duration:'3 yr',      toILR:null,                           accent:'#3B82F6', icon:HomeIcon,     tab:'special',     badge:'Free',        href:'/visa-types/ukraine'           },
];
    ...
    <div className="min-h-screen" style={{ background: '#FFFFFF', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <section className="relative overflow-hidden pt-[100px] md:pt-[120px] pb-12 md:pb-16" style={{ background: '#FFFFFF' }}>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Breadcrumb */}
          <div className="pb-7">
            <div className="flex items-center gap-2 text-[12px]" style={{ color: '#3F3F46' }}>
              ...
              <span style={{ color: '#6366F1', fontWeight: 600 }}>UK Visa Hub</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-5"
                ...
                <span className="text-[10.5px] font-bold uppercase" style={{ color: '#6366F1', letterSpacing: '0.18em' }}>
              ...
              <h1 style={{
                ...
                UK Visa <span style={{ fontStyle: 'italic', color: '#6366F1' }}>hub.</span>
              </h1>
              <p className="mt-5 text-[16px] md:text-[18px] leading-[1.6]" style={{ color: '#3F3F46' }}>
                ...
                <div key={s.l} className="px-5 py-3 rounded-xl text-center"
                  ...
                  <div className="tabular-nums"
                       style={{ fontFamily: '"Inter Tight", Inter, sans-serif', fontWeight: 700,
                                fontSize: 22, letterSpacing: '-0.03em', color: '#18181B', lineHeight: 1 }}>
                    {s.n}
                  </div>
                  <div className="text-[11px] mt-1.5 font-medium" style={{ color: '#6B7280' }}>{s.l}</div>
                </div>
              ))}
            </div>
          </div>
            ...
            {SECTIONS.map(s => {
              ...
              return (
                <button
                  ...
                  style={{ color: active ? '#18181B' : '#3F3F46', borderBottom: active ? '2.5px solid #18181B' : '2.5px solid transparent', marginBottom: '-1px' }}
                  onMouseOver={e => { if (!active) (e.currentTarget as HTMLElement).style.color = '#18181B'; }}
                  onMouseOut={e => { if (!active) (e.currentTarget as HTMLElement).style.color = '#3F3F46'; }}
                >
                  <span style={{ color: active ? '#6366F1' : '#6B7280' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10">
          ...
          <div>
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-lg mb-6 overflow-hidden">
                  ...
                  {TABS.map(t => {
                    ...
                    return (
                      <button key={t.id} onClick={() => setActiveTab(t.id)}
                        ...
                        style={{ color: isActive ? t.accent : '#3F3F46', borderBottom: isActive ? `2.5px solid ${t.accent}` : '2.5px solid transparent', marginBottom: '-1px' }}>
                        <TIcon className="w-3.5 h-3.5" />
                        <span className="hidden sm:inline">{t.label}</span>
                        <span className="sm:hidden">{t.label.slice(0, 4)}</span>
                        <span className="text-[10.5px] font-normal tabular-nums" style={{ color: isActive ? t.accent : '#6B7280', opacity: 0.8 }}>{count}</span>
                      </button>
                    );
                  })}
                </div>
              ...
              <div className="px-5 py-3.5 flex flex-wrap items-center justify-between gap-2"
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-bold text-[#18181B] text-[14.5px]" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              {TABS.filter(t => t.id !== activeTab).map(t => {
                ...
                return (
                  <button key={t.id} onClick={() => setActiveTab(t.id)}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[12px] font-semibold border border-[#E5E7EB] bg-white hover:border-[#18181B] transition-colors"
                    style={{ color: '#18181B' }}>
        ...
        {activeSection === 'eligibility' && (
          <div className="max-w-4xl">
            <div className="bg-white border border-[#E5E7EB] rounded-lg overflow-hidden mb-6">
              <div className="px-6 py-5 border-b border-[#F3F4F6]"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="font-bold text-[#18181B] text-[18px]" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>
              ...
              <div className="px-6 py-6 text-center">
                ...
                <Link href="/eligibility"
                  ...
                  style={{ background: 'linear-gradient(135deg, #6366F1 0%, #064E3B 100%)', boxShadow: '0 4px 16px -2px rgba(0,196,180,0.40)' }}>
            ...
            {/* Quick guide by goal */}
            <div className="mb-2">
              <h3 className="font-bold text-[#18181B] text-[16px] mb-4" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>
                Or — pick your goal:
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  { icon: Briefcase, accent: '#6366F1', title: 'I have a UK job offer', desc: 'Skilled Worker, Health & Care, Sportsperson or International Agreement', tab: 'work' as TabId },
                  ...
                  { icon: Plane, accent: '#4F46E5', title: 'I just want to visit', desc: 'Standard Visitor up to 6 months. 10-year multi-entry available.', tab: 'visit' as TabId },
                  ...
                  return (
                    <button key={item.tab}
                      ...
                      className="group flex items-start gap-4 p-4 bg-white border border-[#E5E7EB] rounded-xl text-left hover:border-[#18181B] transition-all duration-100"
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-bold text-[14.5px] text-[#18181B] leading-tight" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>{item.title}</div>
        ...
        {activeSection === 'calculator' && (
          <div>
            <div className="mb-6">
              <h2 className="font-bold text-[#18181B] text-[22px] tracking-[-0.015em]" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
              ...
              <div className="lg:col-span-3 bg-white border border-[#E5E7EB] rounded-lg overflow-hidden">
                <div className="px-6 py-4 border-b border-[#F3F4F6]"
                  ...
                  <div className="flex items-center gap-2.5">
                    <Calculator className="w-5 h-5" style={{ color: '#4F46E5' }} />
                    <span className="font-bold text-[#18181B] text-[15px]" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>Configure your application</span>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select value={calcVisaId} onChange={e => setCalcVisaId(e.target.value)}
                        className="w-full appearance-none bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl px-4 py-3 text-[14px] font-semibold text-[#18181B] outline-none pr-10 transition-colors"
                        style={{ fontFamily: 'Inter,sans-serif' }}
                        onFocus={e => (e.target as HTMLElement).style.borderColor = '#18181B'}
                    ...
                    <div className="flex gap-2 flex-wrap">
                      {[1, 2, 3, 5].map(y => (
                        <button key={y} onClick={() => setCalcYears(y)}
                          ...
                          style={{
                            background: calcYears === y ? '#18181B' : '#fff',
                            color: calcYears === y ? '#fff' : '#18181B',
                            borderColor: calcYears === y ? '#18181B' : 'rgba(26,31,54,0.08)',
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <button onClick={() => setCalcDependants(d => Math.max(0, d - 1))}
                        className="w-10 h-10 rounded-xl border border-[#E5E7EB] flex items-center justify-center text-[#18181B] hover:bg-[#F3F4F6] transition-colors">
                        <Minus className="w-3.5 h-3.5" />
                      </button>
                      <span className="w-10 text-center font-bold text-[20px] text-[#18181B] tabular-nums"
                      ...
                      {[
                        ...
                        <label key={opt.id} className="flex items-center gap-3 cursor-pointer group p-3 rounded-xl border border-[#F3F4F6] hover:border-[#E5E7EB] transition-colors">
                          <input type="checkbox" checked={opt.state} onChange={e => opt.set(e.target.checked)}
                            className="w-4 h-4 rounded" style={{ accentColor: '#18181B' }} />
                          <div>
                            <span className="text-[13.5px] font-semibold text-[#18181B]">{opt.label}</span>
                    ...
                    <>
                      ...
                      <div className="mt-6 pt-5" style={{ borderTop: '1px solid rgba(255,255,255,0.10)' }}>
                        ...
                        <Link href="/tools/cost-calculator"
                          ...
                          style={{ background: '#A7F3D0', color: '#18181B' }}>
            ...
            <div className="mt-4 p-4 bg-white border border-[#E5E7EB] rounded-xl flex flex-wrap items-center gap-4">
              {[
                ...
                { icon: Clock, text: 'Rates correct as of April 2026', color: '#4F46E5' },
              ].map(item => {
                const IIcon = item.icon;
                return (
          ...
          <div>
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-lg overflow-hidden mb-6">
              <div className="px-5 py-4 border-b border-[#F3F4F6]"
                ...
                <h3 className="font-bold text-[#18181B] text-[15px] flex items-center gap-2" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>
              ...
              <div className="p-5 overflow-x-auto">
                <div className="flex items-stretch gap-0 min-w-[600px]">
                  {[
                    { step: '1', title: 'Entry Visa',        desc: 'Skilled Worker, Family, Student, BN(O) or other qualifying route',       accent: '#6366F1', icon: Plane,      dur: 'Day 1' },
                    ...
                    { step: '5', title: 'British Citizenship',desc: 'Naturalisation or registration. Then apply for British passport.',        accent: '#4F46E5', icon: Crown,      dur: '£1,500' },
                  ].map((s, i) => (
                    <div key={s.step} className="flex items-stretch flex-1 min-w-0">
                      <div className="flex-1 rounded-xl border border-[#E5E7EB] p-4 flex flex-col gap-2.5 relative overflow-hidden"
                        ...
                        <div>
                          ...
                          <div className="font-bold text-[13.5px] text-[#18181B] leading-snug" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>{s.title}</div>
            ...
            <div className="mb-6">
              <h3 className="font-bold text-[#18181B] text-[15.5px] mb-3" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
              <Link href="/settlement"
                className="flex items-center justify-between gap-3 p-5 bg-white border border-[#E5E7EB] rounded-xl hover:border-[#18181B] transition-all group"
                style={{ boxShadow: '0 1px 3px rgba(16,26,54,0.04)' }}
                onMouseOver={e => (e.currentTarget as HTMLElement).style.boxShadow = '0 8px 24px -4px rgba(16,26,54,0.12)'}
                onMouseOut={e => (e.currentTarget as HTMLElement).style.boxShadow = '0 1px 3px rgba(16,26,54,0.04)'}>
                <div>
                  <div className="font-bold text-[14.5px] text-[#18181B]" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>Settlement comparison guide</div>
                  <div className="text-[12.5px] text-[#6B7280] mt-0.5">Side-by-side fees, time-to-ILR and English requirements</div>
                </div>
                <ArrowRight className="w-4 h-4 text-[#9CA3AF] group-hover:text-[#18181B] transition-colors flex-shrink-0" />
              </Link>
              <button onClick={() => setActiveSection('calculator')}
                className="flex items-center justify-between gap-3 p-5 bg-white border border-[#E5E7EB] rounded-xl hover:border-[#18181B] transition-all group text-left"
                style={{ boxShadow: '0 1px 3px rgba(16,26,54,0.04)' }}
                onMouseOver={e => (e.currentTarget as HTMLElement).style.boxShadow = '0 8px 24px -4px rgba(16,26,54,0.12)'}
                onMouseOut={e => (e.currentTarget as HTMLElement).style.boxShadow = '0 1px 3px rgba(16,26,54,0.04)'}>
                <div>
                  <div className="font-bold text-[14.5px] text-[#18181B]" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>Calculate ILR fees</div>
        ...
        {activeSection === 'countries' && (
          <div>
                ...
                return (
                  <button key={c.code}
                    ...
                    style={{
                      ...
                      borderColor: isSelected ? '#18181B' : 'rgba(26,31,54,0.08)',
                      boxShadow: isSelected ? '0 4px 12px rgba(26,31,54,0.20)' : 'none',
                    }}
                    onMouseOver={e => { if (!isSelected) { (e.currentTarget as HTMLElement).style.borderColor = '#18181B'; (e.currentTarget as HTMLElement).style.boxShadow = '0 4px 12px rgba(26,31,54,0.08)'; } }}
                    ...
                    <span className="text-[12px] font-semibold leading-tight" style={{ color: isSelected ? '#fff' : '#18181B' }}>{c.name}</span>
                    {c.tbTest && !isSelected && (
                ...
                <div className="px-6 py-5 border-b border-[#F3F4F6]"
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-bold text-[#18181B] text-[20px]" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>
                    ...
                    <Link href={`/from/${selectedCountry.code}`}
                      className="inline-flex items-center gap-1.5 text-[13px] font-bold px-4 py-2 rounded-xl border border-[#18181B] text-[#18181B] hover:bg-[#18181B] hover:text-white transition-all">
                ...
                <div className="px-6 pt-5 pb-4 grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-[#F3F4F6]">
                  ...
                  <div className="rounded-xl p-4 border" style={{ background: '#FFFFFF', borderColor: 'rgba(26,31,54,0.08)' }}>
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      <span className="text-[13px] font-bold text-[#18181B]" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>VAC / Application centre</span>
                    </div>
                    ...
                    {selectedCountry.popularRoutes.map(tabId => {
                      ...
                      return (
                        <button key={tabId}
                          ...
                          style={{ background: `${tab.accent}0c`, borderColor: `${tab.accent}30`, color: '#18181B' }}
            ...
            <div className="mt-4 text-center">
              <Link href="/from"
                className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-[#18181B] hover:underline">
      ...
      <div className="border-t border-[#E5E7EB] bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                { href: '/eligibility',               label: 'Eligibility quiz',       accent: '#6366F1' },
                { href: '/tools/cost-calculator',     label: 'Cost calculator',        accent: '#4F46E5' },
                { href: '/tools/salary-checker',      label: 'SOC salary check',       accent: '#1E3A8A' },
                { href: '/tools/sponsor-search',      label: 'Sponsor search',         accent: '#18181B' },
                { href: '/ihs-calculator',            label: 'IHS calculator',         accent: '#E11D48' },
                { href: '/settlement',                label: 'Settlement guide',       accent: '#10B981' },
              ].map(t => (
                <Link key={t.href} href={t.href}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#FFFFFF] border border-[#E5E7EB] hover:border-[#18181B] text-[12.5px] font-semibold text-[#374151] transition-colors">
            ...
            <Link href="/"
              className="inline-flex items-center gap-1.5 text-[12.5px] font-semibold text-[#6B7280] hover:text-[#18181B] transition-colors">
              ← Back to all tools
            </Link>
          </div>
        </div>
...
function VisaCard({ r }: { r: VisaRoute }) {
  ...
  const badgeColor = r.badge ? (badgeColors[r.badge] ?? '#3F3F46') : null;
  return (
    <Link href={r.href}
      ...
      <div className="flex-1">
        <h3 className="font-bold text-[#18181B] text-[14.5px] tracking-[-0.005em] leading-snug"
      ...
      <div className="flex items-center justify-between gap-2 pt-2.5 border-t border-[#F3F4F6]">
        <div>
          ...
          <div className="font-bold text-[12.5px] text-[#18181B] tabular-nums"
...
function InfoPill({ ok, label, desc }: { ok: boolean; label: string; desc: string }) {
  return (
    <div className="rounded-xl p-4 border" style={{
      background: ok ? 'rgba(99,91,255,0.08)' : '#EEF2FF',
      borderColor: ok ? 'rgba(99,91,255,0.30)' : 'rgba(88,81,219,0.30)',
    }}>
      <div className="flex items-center gap-2 mb-1.5">
        {ok
          ? <CheckCircle2 className="w-4 h-4 flex-shrink-0" style={{ color: '#6366F1' }} />
          : <XCircle className="w-4 h-4 flex-shrink-0" style={{ color: '#4F46E5' }} />
        }
        <span className="text-[13px] font-bold text-[#18181B]" style={{ fontFamily: '"Inter Tight", Inter, sans-serif' }}>{label}</span>
      </div>
