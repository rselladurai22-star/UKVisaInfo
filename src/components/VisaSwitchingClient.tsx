...
const DIFFICULTY_STYLE: Record<string, { bg: string; color: string; label: string }> = {
  Common:      { bg: '#2563eb15', color: '#2563eb', label: 'Common switch' },
    ...
    <div className="min-h-screen" style={{ background: '#FFFFFF', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <section className="relative overflow-hidden pt-[84px] md:pt-[96px] pb-10 md:pb-12"
        ...
        <div className="relative max-w-[1200px] mx-auto px-5 md:px-8">
          ...
          <h1 style={{
            fontFamily: 'var(--font-grotesk), var(--font-inter), sans-serif',
            fontWeight: 800,
            ...
            Visa <span style={{ color: '#2563eb' }}>switching</span> guide
          </h1>
      ...
      <div className="max-w-[1200px] mx-auto px-5 md:px-8 py-8 md:py-12 grid grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:sticky lg:top-[100px] space-y-4">
            <div className="rounded-lg bg-white border border-[#E5E7EB] p-6"
              ...
              <div className="flex items-center gap-2 mb-2.5">
                <span className="w-[3px] h-[14px] rounded-full bg-[#2563eb]" />
                <span className="text-[10.5px] font-extrabold uppercase tracking-[0.16em] text-[#1e3a8a]"
                      style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
                  Step 1 · Your current visa
                </span>
              </div>
              <h3 className="text-[17px] font-extrabold text-[#0f172a] mb-1"
                  style={{ fontFamily: 'var(--font-grotesk), var(--font-inter), sans-serif' }}>
                I am currently on…
              </h3>
            ...
            <Link href="/tools/cost-calculator"
                  ...
                  style={{ background: 'linear-gradient(135deg, #2563eb, #1e3a8a)', boxShadow: '0 8px 30px -8px rgba(37,99,235,0.5)' }}>
              <div>
        ...
        <main className="col-span-12 lg:col-span-8 space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2.5">
              <span className="w-[3px] h-[18px] rounded-full bg-[#2563eb]" />
              <span className="text-[10.5px] font-extrabold uppercase tracking-[0.18em] text-[#1e3a8a]"
                    style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
                Step 2 · Where you can switch to
              </span>
            </div>
            <h2 className="text-[23px] md:text-[28px] font-extrabold text-[#0f172a] tracking-[-0.022em] leading-[1.12]"
                style={{ fontFamily: 'var(--font-grotesk), var(--font-inter), sans-serif' }}>
              From <span style={{ color: '#1e3a8a' }}>{from.label}</span>{' → '}
            </h2>
          ...
          {from.switches.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {from.switches.map((s) => {
                const color = CATEGORY_COLORS[s.category] ?? '#0f172a';
                ...
                return (
                  <Link key={s.toSlug + s.toTitle} href={`/visa-types/${s.toSlug}`}
                        className="group block rounded-lg bg-white border border-[#E5E7EB] p-5 hover:border-[#0f172a] transition-all"
                    ...
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h3 className="text-[15.5px] font-extrabold text-[#0f172a] leading-tight"
                            style={{ fontFamily: 'var(--font-grotesk), var(--font-inter), sans-serif' }}>
                          {s.toTitle}
                        </h3>
                      </div>
                    ...
                    <div className="flex items-center justify-between gap-2 pt-3 border-t border-[#F3F4F6]">
                      ...
                      <span className="inline-flex items-center gap-1 text-[13px] font-bold text-[#0f172a] group-hover:gap-2 transition-all"
                            style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
                        See full guide
            ...
            <div className="rounded-lg bg-white border border-amber-200 p-7"
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-[16px] font-extrabold text-[#0f172a] mb-2"
                      style={{ fontFamily: 'var(--font-grotesk), var(--font-inter), sans-serif' }}>
          ...
          <div className="rounded-lg bg-white border border-[#E5E7EB] overflow-hidden mt-2"
            ...
            <div className="px-6 py-4 border-b border-[#F3F4F6] flex items-center gap-3"
              ...
              <div>
                <div className="text-[10.5px] font-extrabold uppercase tracking-[0.16em] text-[#1e3a8a]"
                     style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              ...
              {SWITCH_STEPS.map((s, i) => (
                <li key={i} className="px-6 py-5 md:px-8 md:py-6 flex gap-5">
                  <span aria-hidden
                        ...
                        style={{ background: '#2563eb', boxShadow: '0 4px 14px -4px rgba(37,99,235,0.6)', fontFamily: 'var(--font-grotesk), var(--font-inter), sans-serif' }}>
                    {i + 1}
                  </span>
                  <div className="flex-1 min-w-0">
                    <h4 className="text-[15.5px] md:text-[16.5px] font-extrabold text-[#0f172a] leading-tight mb-1.5"
                        style={{ fontFamily: 'var(--font-grotesk), var(--font-inter), sans-serif' }}>
                      {s.title}
                    </h4>
            ...
            <div className="px-6 py-4 md:px-8 border-t border-[#F3F4F6] bg-[#FAFBFC] flex flex-wrap gap-3">
              <a href="https://www.gov.uk/check-uk-visa" target="_blank" rel="noopener noreferrer"
                 className="inline-flex items-center gap-2 text-[13px] font-bold text-[#0f172a] hover:underline">
  ...
  return (
    <div className="flex items-start gap-3">
      <span className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
            style={{ background: 'rgba(37,99,235,0.12)', color: '#1e3a8a' }}>
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-[13px] font-bold text-[#0f172a] leading-snug mt-0.5"
             style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
          {value}
        </div>
      </div>
