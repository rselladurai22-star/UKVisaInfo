              ...
              <button
                ...
                className={`relative whitespace-nowrap px-4 py-2 rounded-lg text-sm font-semibold transition-all ${
                  filter === c
                    ...
                    : 'bg-transparent text-[#52596e] hover:text-[#0A2540] hover:bg-[rgba(14,20,36,0.05)]'
                }`}
              ...
              {filtered.map((visa, i) => (
                ...
                >
                  ...
                  <div className="p-6 md:p-7">
                    ...
                    <h3 className="font-display text-[1.0625rem] md:text-[1.125rem] font-bold text-[#0A2540] leading-snug">
                      {visa.title}
                    </h3>
                    ...
                    <dl className="mt-5 grid grid-cols-2 gap-3">
                      <div className="bg-[#f9fafb] rounded-xl px-3 py-2.5">
                        ...
                        <dd className="text-sm font-bold text-[#0A2540]">{visa.salary}</dd>
                      </div>
                      <div className="bg-[#f9fafb] rounded-xl px-3 py-2.5">
                        <dt className="flex items-center gap-1 text-[10px] text-[#52596e] font-semibold uppercase tracking-wider mb-1">
                          <Clock className="w-3 h-3" /> Duration
                        </dt>
                        <dd className="text-sm font-bold text-[#0A2540]">{visa.duration}</dd>
                      </div>
                    </dl>
                    ...
                    <div className="mt-5 flex gap-2">
                      {VISA_DETAILS[visa.id] ? (
                        ...
                        <a
                          ...
                          className="flex-1 inline-flex items-center justify-center gap-1.5 bg-[rgba(14,20,36,0.05)] text-[#0A2540] font-semibold text-[13px] py-2.5 rounded-xl hover:bg-[rgba(14,20,36,0.09)] transition-colors"
                        >
