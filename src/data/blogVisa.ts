...
// 29 original visa posts (split out of blog.ts).
export const VISA_POSTS: BlogPost[] = [
  {
...
Yes, via ILR. Five years on Skilled Worker → ILR → 12 months holding ILR → citizenship application. Total: around 6 to 7 years from first entry. The full sequence: Skilled Worker 3 years → extend 2 years → apply ILR → wait 12 months → apply for naturalisation.
...
1. **TB test** (£80 to £200), required if you're applying from a listed country including India, Pakistan, Nigeria, Bangladesh, most of Southeast Asia and sub-Saharan Africa. Must be done at an IOM-approved clinic.
2. **ATAS clearance** (£0 but ~4 weeks to obtain), required for some STEM postgrad courses. Delays people every year.
3. **English test** (£175 to £230), IELTS/UKVI, PTE Academic or equivalent. Some universities accept their own in-house test, which is cheaper.
4. **Translations** (£30 to £150 per document), all non-English documents must be certified translations.
5. **Biometrics appointment fee** (£0 to £150), paid to the VFS or TLS centre; some locations add a premium for weekend slots.
6. **CAS issue fee**, most universities include this, but a few charge £50 to £100.
7. **Airport pickup, initial accommodation deposit**, typically £500 to £1,500 before you've unpacked.
...
> A: Most UK universities allow two or three instalments per academic year. Some require a deposit (usually £1,000 to £3,000) before issuing the CAS. Read the fee schedule carefully, late payment penalties are real.
>
...
For postgraduate students on certain STEM subjects, Academic Technology Approval Scheme (ATAS) clearance is mandatory. It is free but takes 4 to 6 weeks. Apply for ATAS the moment you receive your CAS. Do not submit the visa application without ATAS if it's required for your course.
...
If you're completing your thesis and need extra time beyond your current visa, you can apply for a Student visa extension. Your supervisor must confirm continued registration. This is usually granted for 6 to 12 months. The university must issue a new CAS for the extension period.
...
Bank statements are the most time-consuming to obtain. Many UK banks provide only 3 months of statements free of charge; older statements require a branch request or fee-based archive request, often taking 2 to 3 weeks. Begin pulling 6 months of statements 4 to 6 weeks before you plan to submit.
...
Under Housing Act standards, each couple needs 1 bedroom. Each child under 10 can share with any other child. Children aged 10 to 15 can share with a same-sex sibling. Children 16+ need their own bedroom or shared with a partner if married.
...
- In-country ILR, reports of 6 to 9 months common, even though the target is "6 months."
...
|---|---|---|---|---|
| India | 5 to 10 days | 12 to 18 days | 14 to 22 days | 14 to 18 weeks |
| Nigeria | 7 to 14 days | 14 to 20 days | 18 to 28 days | 16 to 22 weeks |
| Pakistan | 10 to 16 days | 14 to 21 days | 20 to 30 days | 18 to 26 weeks |
| Bangladesh | 10 to 18 days | 14 to 21 days | 20 to 28 days | 16 to 24 weeks |
| Philippines | 5 to 10 days | 10 to 16 days | 14 to 20 days | 12 to 18 weeks |
| USA | 3 to 7 days | 8 to 14 days | 10 to 16 days | 12 to 16 weeks |
| Australia | 2 to 5 days | 7 to 12 days | 10 to 14 days | 10 to 14 weeks |
| China | 5 to 10 days | 10 to 16 days | 12 to 18 days | 12 to 18 weeks |
| South Africa | 5 to 10 days | 12 to 18 days | 14 to 20 days | 14 to 18 weeks |
| UAE | 3 to 7 days | 8 to 14 days | 10 to 16 days | 12 to 16 weeks |
...
> A: First-tier Tribunal hearing dates are currently running 8 to 14 months from lodgement of the appeal. Administrative review (for eligible refusals) is faster, typically 8 to 12 weeks. Check whether your refusal letter states you have a right of appeal or only a right to administrative review.
...
1. Covering letter: 1 to 2 pages summarising the application, your role, CoS reference, salary, any discretion being claimed.
...
**"Decision made"**, a decision has been reached. A vignette sticker (for overseas grants) or eVisa update (for in-country grants) will follow within 1 to 5 working days.
...
`.trim(),
...

  {
    ...
    title: 'UK Graduate Visa 2026 to 2 Years Post-Study, No Sponsor Needed',
    description:
...
**Months 10 to 14:** Get the Certificate of Sponsorship (CoS) issued. Apply to switch from Graduate to Skilled Worker.
...
|---|---|---|
| Junior software developer | £35,000 to £45,000 | Yes |
| Graduate civil engineer | £26,000 to £32,000 | Borderline, some under |
| Accountant (ACA trainee) | £27,000 to £32,000 | Borderline |
| Data analyst | £30,000 to £40,000 | Usually yes |
| Marketing executive | £24,000 to £30,000 | Usually no |
| NHS junior doctor (FY1) | £36,600 | Yes |
| Registered nurse | £28,407 to £34,581 | Borderline, use Health & Care route |
| Financial analyst | £35,000 to £45,000 | Yes |
| Secondary teacher (NQT) | £30,000 to £38,000 | Borderline (regional) |
...
`.trim(),
...

  {
    ...
    title: 'UK ILR (Indefinite Leave to Remain) 2026 to 5-Year Route Requirements',
    description:
...
Study approach:
1. Read the handbook once cover-to-cover (3 to 4 hours).
...
How to fix it: provide the sponsor's most recent 3 to 6 months of bank statements, payslips, BRP or eVisa share code, a signed sponsor letter naming you, and proof of accommodation (tenancy, mortgage). The sponsor's monthly disposable income must comfortably cover your stay.
...
You didn't show you had enough money for your trip, or didn't show you had somewhere to stay. Bank statements showing a consistent balance (not a recent spike deposit) over 3 to 6 months address this. For visiting family, a sponsor's declaration and their own financial evidence is required.
...
> A: There is no mandatory waiting period for visit visas. Reapply when you have better evidence, typically at least 3 to 4 weeks to gather meaningful new documents. Applying the next day with the same evidence will be refused again.
>
...
| Student visa (below degree RQF 3 to 5) | B1 | Foundation, A-level, etc. |
...
| LanguageCert SELT | A1, C2 | £140 to £190 |
...
| Student (university requirement) | IELTS Academic | Usually B2 or above | Typically 6.0 to 7.0 |
...
2. Submit detailed business plan (15 to 40 pages)
3. Pay assessment fee (£500 to £3,000 depending on body)
4. Interview with endorser's review panel (60 to 90 minutes)
...
6. **Underestimating the timeline.** Most successful applicants spend 6 to 12 months on the plan and endorsement process before applying.
...
2. **Problem and opportunity** (1 to 2 pages), specific pain point, market research, size of opportunity.
3. **Product/service** (1 to 2 pages), how it works, differentiation, current development status.
4. **Business model** (1 page), how money is made, pricing, unit economics.
5. **Go-to-market strategy** (1 to 2 pages), customer acquisition, partnerships, initial traction.
6. **Competitive landscape** (1 page), direct and indirect competition, your position.
7. **Financial projections** (1 to 2 pages), 3-year P&L and cash flow forecast with assumptions.
8. **Team** (1 page), founder CVs, relevant experience, advisory board.
9. **UK impact** (0.5 to 1 page), job creation, investment raised or planned, IP generated in the UK.
...
Total visa and endorsement costs over 3 years to ILR: approximately **£7,000 to £10,000**, excluding the business itself. Compare this to Skilled Worker, which costs approximately £4,500 to £6,500 per person, Innovator Founder costs more but provides a faster ILR path (3 years vs 5 years), saving 2 years of potential IHS and visa fees for any dependants.
`.trim(),
  },
...
"I am [name], a [occupation] based in [city, country]. I am applying for a UK Standard Visitor visa to [specific purpose: attend my daughter's graduation ceremony at the University of Edinburgh on 15 July 2026 / attend the 3-day fintech conference at Excel London from 10 to 12 September 2026]."
...
> A: For Visit visa reapplications after refusal, a solicitor can significantly improve the quality of the cover letter and document bundle. The cost (£500 to £1,200 for preparation) is often worthwhile given the stress and planning involved in the visit.
...
|---|---|---|---|
| Software Engineer | £50,000 to £80,000 | 2136 | High volume, many sponsors |
| Data Scientist | £45,000 to £70,000 | 2425 | Growing demand, strong salaries |
| Cloud Architect | £70,000 to £120,000 | 2135 | Often via consultancy sponsors |
| NHS Junior Doctor | £36,616 to £70,000+ | 2211 | Health & Care route |
| Registered Nurse | £28,407 to £43,742 | 2231 | Health & Care route |
| Civil Engineer | £42,000 to £60,000 | 2121 | Large infrastructure firms |
| Financial Analyst | £40,000 to £60,000 | 2422 | Banking and finance sector |
| Secondary Teacher (Maths) | £31,650 to £50,000 | 2314 | Schools on shortage list |
`.trim(),
  },
...
5. **Applying without Life in the UK Test booked**, test centres book out 2 to 6 weeks in advance
...
Unlike the 5-year Skilled Worker ILR (where evidence is primarily from your employer), the 10-year route requires evidence from potentially 5 to 6 different visa periods. Here is a systematic approach:
...
A 2 to 3 page narrative setting out your 10-year residence period, the visa routes you held, key dates, and why any complexities (gaps, absences, route changes) don't break continuity. This gives the caseworker context and reduces the chance of a hold-up for an information request.
...
1. **Months 1 to 3**: Build medical evidence, multiple specialist reports, current care logs
2. **Months 4 to 5**: Conduct in-country care cost analysis with quotes from providers
3. **Months 6 to 7**: Prepare sponsor evidence and statement of support
4. **Month 8**: Consider immigration solicitor consultation (£300 to 800 for a strategic review)
...
**Duration per visit:**
Standard visitors can be granted up to 6 months per leave. For parents with strong ties to their home country, applying for and receiving a 10-year multiple-entry visit visa is common, with individual visits of 3 to 6 months.
...
> A: ADR applications are processed as part of the general family visa queue. Overseas applications take 12 to 24 weeks on average. There is no priority service available.
...
**Year 1:**
Apply for a Standard Visitor visa with a maximum initial request of 3 to 4 months. If granted, complete the visit within the allotted time. Return home with buffer time (1 to 2 weeks) before the visa expires.
...
`.trim(),
...

  {
    ...
    description:
      'Critical 2026 guide to migrating from BRP to eVisa before key deadlines. How to create your UKVI account, link your passport, and avoid the boarding refusals that hit thousands of travellers in 2025 to 26.',
    date: '2026-05-18',
    updated: '2026-05-18',
    readMinutes: 7,
...
3. **"The airline will figure it out at check-in."** Airlines lose £2,000 to 10,000 per "carrier liability" for transporting someone without valid status. They won\'t risk it.
...
**Lost passport:**
If you've lost the passport your visa was originally issued in, you'll need to use your new passport and provide both numbers (old and new) when creating the account. UKVI may need to manually match your records. This takes 3 to 5 working days via the Resolution Centre.
...
Biometrics appointments at VFS centres in popular countries (India, Nigeria, Pakistan) often have **2 to 3 week lead times**. Book as soon as your application is submitted, waiting increases the total time.
...
> A: Yes. Most family visa refusals carry a right of appeal to the First-tier Tribunal (Immigration and Asylum Chamber). The appeal process takes 8 to 14 months. Consider whether the grounds for refusal are fixable (e.g. missing document), in which case a new application may be faster than an appeal.
...
The property must meet the Housing Act occupancy standard (1 room per couple, 1 additional per 1 to 2 children). A studio apartment with a couple and 2 children will fail. A 2-bedroom house is fine.
...
- Months 9 to 14: Receive and accept offer, employer gets CoS issued
...
**Months 1 to 3:** Arrive, set up (bank account, NI number, accommodation), start targeted job applications focused on sponsors
**Months 4 to 9:** Build professional network, attend industry events, engage with recruiters
**Months 10 to 18:** Secure Skilled Worker role, negotiate CoS
**Months 18 to 24:** Apply for Skilled Worker visa, begin ILR clock
...
**Month 1 to 6:** Arrive, settle, network. Take any work that builds your UK professional profile.
**Month 6 to 12:** Build UK-relevant experience. Aim to be demonstrably excellent in your field within 12 months.
**Month 12 to 18:** Switch to Skilled Worker if you have the right offer. Begin the 5-year ILR clock.
**Month 18 to 24:** If not on Skilled Worker yet, consider ILR clock implications. Every month past 18 that you're on HPI is a month added to the total UK time before citizenship.
...
- Ideally include 1 to 2 recommenders from outside the organisation you currently work for
...
2. **Initial screening**, 3 to 5 working days. Checks completeness, not quality.
3. **Assessment panel review**, 4 to 8 weeks. A panel of senior experts in your field reviews the application.
...
Total endorsement timeline: 6 to 10 weeks from submission to decision.
...
| Endorsement needed | Yes (6 to 10 weeks) | No (CoS from employer) |
| Fee | £716 | £827 to £1,636 |
...
3. Processing: target 28 days (often takes longer, 6 to 10 weeks in practice)
4. Decision: either the original decision is maintained, or the refusal is overturned and the visa granted

**Success rate:** Around 15 to 25% of ARs succeed. Many that succeed do so on clear caseworker errors (miscalculated salary, a document recorded as not submitted when it was). If the AR is about a judgement call, the reviewing officer almost always upholds the original decision.
...
- Acknowledgement: 2 to 4 weeks
- Case Management Review: 4 to 8 weeks after acknowledgement
- Hearing date allocation: **8 to 14 months** from filing in 2025 to 2026
- Decision after hearing: 4 to 12 weeks

**Total time from refusal to decision: typically 10 to 16 months**
...
- **Legal representation:** £2,000 to £8,000 for a solicitor to prepare and attend the appeal. Barristers for complex cases: £1,500 to £5,000 per day
- **McKenzie friend (non-lawyer advocate):** £500 to £2,000, can assist but cannot represent at the hearing
...
As a guide to realistic timelines based on 2024 to 2025 data:

| Country of origin | Family appeal hearing wait (London) | Family appeal hearing wait (Manchester) |
|---|---|---|
| India | 10 to 14 months | 8 to 12 months |
| Pakistan | 12 to 16 months | 10 to 14 months |
| Bangladesh | 12 to 16 months | 10 to 14 months |
| Nigeria | 10 to 14 months | 8 to 12 months |
| Philippines | 10 to 14 months | 8 to 12 months |
| USA | 10 to 14 months | 8 to 12 months |

These timelines reflect the tribunal's current hearing allocation. They are likely to remain at 8 to 14 months for the foreseeable future given ongoing resource constraints.

## Success rate data, what to expect

Based on FTT IAAC statistics for 2024 to 2025:
...
The Home Office processes extension applications in order. Applying very early doesn't speed up the decision but does result in you paying IHS for a period when your existing visa provides coverage. Most applicants apply 4 to 8 weeks before expiry.
...
|---|---|---|
| Standard (in-country) | 8 weeks | 3 to 5 weeks off-peak; 5 to 8 weeks peak |
...
**"ATAS not obtained":**
- Apply for ATAS immediately (free, 4 to 6 weeks)
...
An appeal takes 10 to 16 months. A reapplication with strong evidence takes 12 to 20 weeks. If the refusal was due to a specific document failing, reapplying is usually better.
