...
export const CALC_GUIDES: Record<string, GuideLink[]> = {
  '/take-home-pay': [G.tax50k, G.tax100k, G.sacrifice, G.ni, G.childben],
  '/national-insurance-calculator': [G.ni, G.tax50k, G.sacrifice],
  ...
  '/vehicle-tax-calculator': [G.cartax, G.evpetrol],
  '/car-running-costs': [G.cartax],
