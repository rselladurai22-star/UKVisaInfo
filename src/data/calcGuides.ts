...
const G = {
  ...
  sdlttable: { slug: 'stamp-duty-by-price-table-2025-26', title: 'Stamp duty by house price (table)' },
  mortgagetable: { slug: 'how-much-mortgage-can-i-borrow-by-salary-table-2025-26', title: 'Mortgage borrowing by salary (table)' },
  dividendtable: { slug: 'dividend-tax-by-amount-table-2025-26', title: 'Dividend tax by amount (table)' },
  pensiontable: { slug: 'pension-pot-for-retirement-income-table-2025-26', title: 'Pension pot needed (income table)' },
  minwagetable: { slug: 'minimum-wage-annual-salary-by-hours-2025-26', title: 'Minimum wage as annual salary' },
  isatable: { slug: 'isa-investment-growth-table-2025-26', title: 'ISA growth table' },
...
export const CALC_GUIDES: Record<string, GuideLink[]> = {
  ...
  '/pension-calculator': [G.pensiontable, G.retire, G.sacrifice, G.isapension],
  '/pension-drawdown-calculator': [G.pensiontable, G.retire],
  '/state-pension': [G.pensiontable, G.retire, G.ni],
  '/minimum-wage-checker': [G.minwagetable],
  '/sole-trader-vs-limited': [G.soletrader, G.vat],
  '/corporation-tax-calculator': [G.soletrader, G.vat],
  '/salary-vs-dividend-calculator': [G.dividendtable, G.soletrader],
  '/vat-calculator': [G.vat, G.soletrader],
  '/stamp-duty-calculator': [G.sdlttable, G.sdlt, G.ftbsdlt],
  '/mortgage-calculator': [G.mortgagetable, G.mortgageborrow, G.ftbsdlt],
  '/mortgage-affordability': [G.mortgagetable, G.mortgageborrow],
  ...
  '/isa-calculator': [G.isatable, G.isapension],
  '/compound-interest-calculator': [G.isatable],
