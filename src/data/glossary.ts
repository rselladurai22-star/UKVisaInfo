...
export const GLOSSARY: Record<string, string> = {
  ...
  'ILR': 'Indefinite Leave to Remain, permanent settlement status, usually after 5 to 10 years of qualifying residence.',
  'Indefinite Leave to Remain': 'Permanent settlement status, usually after 5 to 10 years of qualifying residence.',
