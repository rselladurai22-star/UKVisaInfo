  ...
  'family-law': [
    {
      ...
      items: [
        { label: 'Divorce Cost', href: '/divorce-cost-calculator', hint: 'Court + legal fees', status: 'live' },
        { label: 'Financial Settlement', href: '/financial-settlement-calculator', hint: 'Asset split estimate', status: 'live' },
        { label: 'Child Maintenance', href: '/child-maintenance-calculator', hint: 'Statutory CMS rates', status: 'live' },
        { label: 'Spousal Maintenance', href: '/spousal-maintenance-calculator', hint: 'Ongoing support estimate', status: 'live' },
      ],
    },
  ],
  ...
  benefits: [
    {
      ...
      items: [
        ...
        { label: 'Universal Credit', href: '/universal-credit-calculator', hint: 'Allowance + elements', status: 'live' },
        { label: 'Council Tax Support', href: '/council-tax-support-checker', hint: 'Reduction eligibility', status: 'live' },
        { label: 'PIP Checker', href: '/pip-benefit-checker', hint: 'Daily living + mobility', status: 'live' },
        { label: "Carer's Allowance", href: '/carers-allowance-calculator', hint: '£83.30/wk eligibility', status: 'live' },
      ],
    },
  ],
};
