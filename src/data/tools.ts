...
export const CATEGORIES: Category[] = [
  { id: 'property',    label: 'Mortgages & Property',       icon: HomeIcon,     color: '#2563eb', description: 'Mortgages, SDLT, rental income and costs' },
  { id: 'insurance',   label: 'Insurance',                  icon: Shield,       color: '#6366f1', description: 'Life cover, health, rebuild costs and more' },
  { id: 'loans',       label: 'Loans, Debt & Credit',       icon: LandmarkIcon, color: '#4338ca', description: 'APR comparisons, debt consolidation and credit strategy' },
  { id: 'immigration', label: 'Immigration & Visas',        icon: Plane,        color: '#4f46e5', description: 'Visa fees, IHS calculator and points check' },
  { id: 'savings',     label: 'Pensions, Investing & Savings', icon: PiggyBank,   color: '#0d9488', description: 'State pension, ISAs, compound interest' },
  { id: 'tax',         label: 'Tax & Income',               icon: Wallet,       color: '#0284c7', description: 'Income tax, NI, dividends, CGT and more' },
  { id: 'business',    label: 'Business & Self-Employed',   icon: Building2,    color: '#7c3aed', description: 'Self-employed, contractors and Ltd companies' },
  { id: 'estate',      label: 'Wills, Probate & Inheritance', icon: FileText,    color: '#0e7490', description: 'Inheritance tax, probate fees and wills' },
  { id: 'family-law',  label: 'Divorce & Family Law',       icon: Users,        color: '#5b21b6', description: 'Divorce costs, maintenance and asset split' },
  { id: 'energy',      label: 'Energy & Bills',             icon: Zap,          color: '#0369a1', description: 'Energy price cap and solar panel ROI' },
  { id: 'employment',  label: 'Employment & Salary',        icon: Briefcase,    color: '#0891b2', description: 'Redundancy pay, holiday entitlement and SSP' },
  { id: 'vehicles',    label: 'Vehicles & Motoring',        icon: Car,          color: '#0ea5e9', description: 'ULEZ compliance, MOT and vehicle tax' },
  { id: 'benefits',    label: 'Benefits',                   icon: Gift,         color: '#3b82f6', description: 'Universal credit and childcare costs' },
];
