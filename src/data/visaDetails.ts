...
export const VISA_DETAILS: Record<string, VisaDetail> = {
  ...
  'ilr': {
    ...
    category: 'Family',
    fee: '£3,029 (Set(M)/(O)/(F)/(LR)) per adult · £3,029 per dependent child',
    ...
    steps: [
      ...
      { title: 'Apply online & pay', desc: '£3,029 main fee + optional £1,000 Super Priority. Same fee applies to each dependent family member.' },
    ...
    notes: [
      'Cost-comparison example: Set(O) Skilled Worker applicant alone — £3,029 application + £50 LITUK ≈ £3,079. Family of 4 (you + spouse + 2 children) ≈ £12,116 in application fees alone.',
  ...
  'citizenship': {
    ...
    category: 'Family',
    fee: '£1,839 adult (Form AN including £130 ceremony) · £1,214 child (Form MN1) · biometrics free',
    ihs: 'None',
    ...
    notes: [
      ...
      'Children born outside the UK to a British-by-descent parent can usually be registered under MN1 (£1,214).',
  ...
  'bno': {
    ...
    steps: [
      ...
      { title: 'Apply for ILR after 5 years', desc: 'Standard ILR rules apply: 5 years continuous residence, max 180 days absent/year, Life in the UK Test, B1 English, £3,029 fee.' },
    ...
    notes: [
      ...
      'Family of 4 cost to citizenship (6 years from arrival): ~£19,250 + 4 × £3,029 ILR + 2 × £1,839 citizenship + 2 × £1,214 child MN1 = £37,478 across 6 years.',
  ...
  'ancestry': {
    ...
    steps: [
      ...
      { title: 'Apply for ILR after 5 years', desc: 'Standard ILR rules: £3,029, max 180 days absent/year, Life in the UK Test, B1 English.' },
    ],
    notes: [
      '5-year total cost (single adult): £726 application + 5 × £1,035 IHS = £5,901 (gov.uk verified May 2026). Plus £3,029 for ILR after 5 years.',
