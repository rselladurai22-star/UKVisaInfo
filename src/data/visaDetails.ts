...
export const VISA_DETAILS: Record<string, VisaDetail> = {
  ...
  'visitor': {
    ...
    summary:
      'For short stays up to 6 months. From 2024 to 2025 the ETA scheme was rolled out globally for visa-exempt nationals, check whether you need a visa or an Electronic Travel Authorisation (£20) instead.',
  ...
  'talent': {
    ...
    ihs: '£1,035 / year',
    duration: '1 to 5 years per application, unlimited extensions',
    processing: { outside: '3 weeks', inside: '8 weeks' },
    eligibility: [
