...
export const VISA_FAQS: Record<string, FAQ[]> = {
  'skilled-worker': [
    ...
    },
    {
      ...
      answer:
        'Yes. Spouses, civil partners, unmarried partners (2+ years cohabitation) and children under 18 can apply as dependants. Each pays the application fee (£827 to £1,636) and IHS (£1,035/year adult, £776/year child). Dependants can work in any job without sponsorship.',
    },
    {
  ...
  family: [
    ...
    },
    {
      ...
      answer:
        'Application fee: £1,938 (out of UK) or £1,321 (in-UK extension). IHS: £1,035/year. For a 30-month initial visa: £1,938 + £3,105 IHS = £5,043. Plus optional priority service £573 to £1,000. Family route total to ILR (initial + extension + ILR) is around £15,000 over 5 years for a single applicant.',
    },
    {
  ...
  'innovator-founder': [
    ...
    },
    {
      ...
      answer:
        'As of 2026, four approved bodies: Envestors Limited, UK Endorsement Services Limited, Innovator International, and the Global Entrepreneurs Programme (GEP). Each has its own application portal, fee (£500 to £3,000), and assessment process. Approval rates are typically 30 to 40%.',
    },
    {
  ...
  'bno': [
    ...
    { question: 'How much does the BNO visa cost?', answer: '£180 for 2.5 years or £298 for 5 years, plus IHS of £1,035/year per adult and £776/year per child. A family of 4 on 5-year visas can expect £15,000 to £20,000 total upfront.' },
